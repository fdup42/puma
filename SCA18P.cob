      ...
      ******************************************************************        
      *                                                                *        
      *        S C A 1 8 P  -  C A L C U L  REV / ASS / COT            *
      *                                                                *        
      *        E X E R C I C E    2 0 1 8  -  P U M A                  *
      *                                                                *
      *                                                                *        
      ******************************************************************
      * Ce sous-programme est spécifique pour l'exercice 2018. Il a    *
      ...
      *                                                                *
      ******************************************************************
      * ADT - Redmine 388634 - 08/2019 - Création.
      * Nouveautés:                                                    *
      * - Nouvelles formules de calcul des revenus SP et AR            *
      * - Rejet des comptes avec revenus AR <= 25% PASS                *
      * - cotisation nulle si                                          *
      *   1AP+RAP+1AS+RAS+FAS+1AL+1AM+RAL+RAM+1AT+1AZ+RAZ+8FV > 0    
      *   NBPLDE = 1
      *   ou                                                           *
      *   1BP+RBP+1BS+RBS+FBS+1BL+1BM+RBL+RBM+1BT+1BZ+8FV > 0   
      *   NBPLDE = 2
      ******************************************************************
      * Redmine 401294 - 09/2019 - Modification des formules de calcul.*
      * Modification des formules SP et AR.                            *
      * Ajout de la distinction entre DECL 1 et NBPLDE 1 ainsi que     *
      * DECL 1 et NBPLDE 2.                                            *
      *
      ******************************************************************
      * Redmine 409636 - 10/2019 - Modification des formules de calcul.*
      * Modification des formules SP et AR.                            *
      * Utilisation calculs intermédiaires                             *
      ******************************************************************
      *
...
U                          UNIX.                                                
      ...
      *
       01  W-CALCUL-INT-AR.
           ...
           03 V-5NA-5NK-5NY-5NZ                     PICTURE S9(15)V99.
           03 V-5HR-5HS-5KY-5KV-5KW-5JU             PICTURE S9(15)V99.
           03 V-5KQ-5KR-5NX-5NQ-5NR-5IU             PICTURE S9(15)V99.
           03 V-3UA-3VG-3VQ-RVG-NVG-RUA-NUA-3VR     PICTURE S9(15)V99.
           03 V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD PICTURE S9(15)V99.
           03 V-5OA-5OK-5OY-5OZ                     PICTURE S9(15)V99.
           03 V-5IR-5IS-5LY-5LV-5LW-5LD             PICTURE S9(15)V99.
           03 V-5LQ-5LR-5OX-5OQ-5OR-5RZ             PICTURE S9(15)V99.
           03 V-COEF-DECL                           PICTURE 9(1).
      ...
      *
                        ...
                        UNTIL    TOT-STAT  = "MRNF"
                           OR    TOT-REFER = "END."
      *
      * Si sortie autre que condition du PERFORM,  code erreur XBASE 
      * dans TOT-STAT (TOT-REFER sert pour sortie sur fin de lecture ok)
              IF NOT ( TOT-STAT = "MRNF"
                    OR TOT-REFER = "END."
                     )
                MOVE ERR-XBASE-LECT   TO CSCAFIP-CD-RET                   
                MOVE TOT-FILE         TO CSCAFIP-PARAM1                   
                MOVE TOT-STAT         TO CSCAFIP-PARAM2
              END-IF
      *        
           END-IF
      *
      ...
      * NBPLDE doit 1 ou 2 sinon erreur. Idem pour DECL.              *
      ...
      * pour le couple compte/année
             MOVE 1                  TO  FLAG-FISC-VIDE
      *
      * Chargement du montant dans la variable de working correspondante
      ...
      *****************************************************************
       CALCUL-REV-AR.
      *--------------
      * - Découpage calcul du revenu AR suivant valeur de DECL
      *
      * FGA - 10/2019 - PUMA - #409636 >>
             PERFORM CALCUL-ELEMENTS-REV-AR
      *       DISPLAY "CPTE : " CSCAFIP-NO-CPT-INT
      *       DISPLAY "NBPLDE : " NBPLDE
      *       DISPLAY "DECL =" DECL
      ...
      *      DSF_OBDE_F_001552	
      *      NBPLE = 1 => 1 personne célibataire, veuve, divorcée
	  *      NBPLE = 2 => 2 personnes mariées ou pacsées
	            EVALUATE NBPLDE
	            WHEN 1
      ...
      * FGA - 10/2019 - PUMA - #409636 >>				
                COMPUTE W-REV-AR  =
                   ...
                   + CHC / 4
                   + CHI / 4
                   + V-5KQ-5KR-5NX-5NQ-5NR-5IU
                   + 5KE + 5NE 
                   + V-5HR-5HS-5KY-5KV-5KW-5JU
                   + 5QD + 5TC + 5SO + 5SV + 3VD + 3VI + 3VF + 2DH
                   + 2EE + 2XX + 2VM + 2DC
                   + V-RDC-NDC
                   + 2FU
                   + V-RFU-NFU    
                   ...
                   + 2GO
                   + V-RGO-NGO
                   + 2DM + 2TT + 2YY + 2ZZ + 2VN + 2VO + 2VP
                   + V-3UA-3VG-3VQ-RVG-NVG-RUA-NUA-3VR
                   + 3PI + 3WG + 3WI + 3WJ + 3WP + 3SJ
                   + 3TJ + 3SK + 3VM + 3VT + 3VC + 3SE
                   + 3WE + 3VZ
                   + V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD
                  - 2BH * 0.068 - 6DE
      * 	       DISPLAY "W-REV-AR-FINAL 1-1 :" W-REV-AR              
      * FGA - 10/2019 - PUMA - #409636 <<                
				WHEN 2
      * FGA - 10/2019 - PUMA - #409636 >>
                COMPUTE W-REV-AR  =
                   ...
                   + V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD
                   - 2BH * 0.068 - 6DE) / 2
      *         DISPLAY "W-REV-AR-FINAL 1-2 :" W-REV-AR
      * FGA - 10/2019 - PUMA - #409636 <<
        	    END-EVALUATE
      * FGA - 09/2019 - PUMA - #401294 <<
      ...
      *      DSF_ODBE_F_001994
               ...
               + CIC / 4 
               + CII / 4
               + V-5LQ-5LR-5OX-5OQ-5OR-5RZ
               + 5LE + 5OE
               + V-5IR-5IS-5LY-5LV-5LW-5LD
               + 5RD + 5UC + 5NT + 5SW
               + V-1AW-RAW-NAW
               + V-1BW-RBW-NBW 
               + V-1CW-RCW-NCW 
               ...
               + V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD
               - 2BH * 0.068 - 6DE) / 2
	  *			DISPLAY "W-REV-AR-FINAL 2 :" W-REV-AR
      * FGA - 10/2019 - PUMA - #409636 <<
            END-IF
                   
      * Si Revenu AR <= PASS * 0.25 --> non éligible PUMA 
      * DSF_ODBE_F_004983 
      *----------------------------------------------------------------
      *     DISPLAY "W-REV-AR : " W-REV-AR
      *     DISPLAY "W-PASS : " W-PASS
      *     DISPLAY "--------------------------"
           IF W-REV-AR <= W-PASS * 0.25
      ...
      *****************************************************************
       CALCUL-REV-SP.
      *--------------
      * - Découpage calcul du revenu SP suivant valeur de DECL
            PERFORM CALCUL-ELEMENTS-REV-SP
       
            IF DECL = 1
      *      DSF_OBDE_F_001551
      * FGA - 10/2019 - PUMA - #409636 >>
               COMPUTE W-REV-SP  ROUNDED =
                 1AJ 
               + V-RAJ-NAJ 
               + DAJ / 4 
               + EAJ / 4 
               ...
               + 5QB + 5QC + 5QH 
               + 5QI + 5QL + 5QM
      *         DISPLAY "W-REV-SR-FINAL DECL 1 :" W-REV-SP    
      * FGA - 10/2019 - PUMA - #409636 <<
           ELSE
      *      DSF_ODBE_F_001993
      * FGA - 10/2019 - PUMA - #409636 >>
               ...
               + 5RB + 5RC + 5RH 
               + 5RI + 5RL + 5RM
      *         DISPLAY "W-REV-SR-FINAL DECL 2 :" W-REV-SP 
      * FGA - 10/2019 - PUMA - #409636 <<
           END-IF

      * Si Revenu SP >= PASS * 10% --> non éligible PUMA 
      * DSF_ODBE_F_001995 
      *----------------------------------------------------------------
           IF W-REV-SP >= W-PASS * 0.10
      ...
      *****************************************************************
       CALCUL-REV-RR.
      *--------------
      * - Calcul du revenu RR suivant le nombre de déclarant
      *
           IF NBPLDE = 1
      *      DSF_OBDE_F_002934
             COMPUTE W-REV-RR ROUNDED = 
      ...
      *----------------------------------------------------------------
       ...
       .
      *****************************************************************
      * Calcul de l'assiette : revenus AR - abattement de 25% du PASS *
      *****************************************************************
       CALCUL-ASSIETTE.
      *--------------------
           COMPUTE W-ABATTEMENT ROUNDED = (W-PASS * 0.25)
      ...
      * Si Revenu SP < PASS * 5%       
      *----------------------------------------------------------------
           IF W-REV-SP < W-PASS * 0.05
             COMPUTE W-COT ROUNDED = (W-ASS-SOC * 0.08)
           END-If
      * Si PASS * 5% <= Revenu SP < PASS * 10%       
      *----------------------------------------------------------------
           IF  W-REV-SP >= W-PASS * 0.05
           AND W-REV-SP <  W-PASS * 0.10
              COMPUTE W-COT ROUNDED = (W-ASS-SOC * 0.08) 
                                    * 2 
                                    * (1 - W-REV-SP / (W-PASS * 0.10 ))
           END-IF
      *
      ...
      *****************************************************************        
       ...
       CALCUL-ELEMENTS-REV-AR.
                ...
                MOVE 0 TO V-1AW-RAW-NAW.
                MOVE 0 TO V-1BW-RBW-NBW.
                MOVE 0 TO V-1CW-RCW-NCW.
                MOVE 0 TO V-1DW-RDW-NDW.
                MOVE 0 TO V-RDC-NDC.
                MOVE 0 TO V-RFU-NFU.
                ...
                IF NAW <> 0 
                  COMPUTE V-1AW-RAW-NAW  = 
                     (1AW + RAW / NAW) * (1 - 0.3)
                END-IF.
      *          DISPLAY "V-1AW-RAW-NAW : " V-1AW-RAW-NAW.
                
                IF NBW <> 0 
                  COMPUTE V-1BW-RBW-NBW  =  
                      (1BW + RBW / NBW) * (1 - 0.5)
                END-IF.
      *          DISPLAY "V-1BW-RBW-NBW : " V-1BW-RBW-NBW.
                
                IF NCW <> 0 
                    COMPUTE V-1CW-RCW-NCW  =  
                     (1CW + RCW / NCW) * (1 - 0.6)                    
                END-IF.
      *          DISPLAY "V-1CW-RCW-NCW : " V-1CW-RCW-NCW.
                
                IF NDW <> 0
                  COMPUTE V-1DW-RDW-NDW  =  
                     (1DW + RDW / NDW) * (1 - 0.7)                    
                END-IF.
      *          DISPLAY "V-1DW-RDW-NDW : " V-1DW-RDW-NDW.
                
                COMPUTE V-5NA-5NK-5NY-5NZ  = 5NA + 5NK - 5NY - 5NZ.
                IF V-5NA-5NK-5NY-5NZ < 0 
                  MOVE 0 TO V-5NA-5NK-5NY-5NZ
                END-IF.
      *          DISPLAY "V-5NA-5NK-5NY-5NZ : " V-5NA-5NK-5NY-5NZ.
                
                COMPUTE V-5KQ-5KR-5NX-5NQ-5NR-5IU  = 5KQ - 5KR + 5NX    
                                                   + 5NQ - 5NR - 5IU.   
                IF V-5KQ-5KR-5NX-5NQ-5NR-5IU < 0                        
                  MOVE 0 TO V-5KQ-5KR-5NX-5NQ-5NR-5IU                   
                END-IF.
      *          DISPLAY "V-5KQ-5KR-5NX-5NQ-5NR-5IU : " 
      *          V-5KQ-5KR-5NX-5NQ-5NR-5IU.
                
                COMPUTE V-5HR-5HS-5KY-5KV-5KW-5JU  = 5HR - 5HS + 5KY
                                            + 5KV - 5KW - 5JU.
                IF V-5HR-5HS-5KY-5KV-5KW-5JU < 0 
                  MOVE 0 TO V-5HR-5HS-5KY-5KV-5KW-5JU
                END-IF.
      *          DISPLAY "V-5HR-5HS-5KY-5KV-5KW-5JU : " 
      *          V-5HR-5HS-5KY-5KV-5KW-5JU.

                 IF NDC <> 0 
                    COMPUTE V-RDC-NDC  = RDC / NDC 
                 END-IF.
      *           DISPLAY "V-RDC-NDC : " V-RDC-NDC.
                 
                 IF NFU <> 0 
                   COMPUTE V-RFU-NFU  = RFU / NFU
                 END-IF.
      *           DISPLAY "V-RFU-NFU : " V-RFU-NFU.
                 
                 MOVE 1 TO V-COEF-DECL.
                 IF (DECL = 1 AND NBPLDE = 2) OR (DECL = 2)
                    MOVE 2 TO V-COEF-DECL
                 END-IF.
             
                 IF NCH = 0
                    IF 2CH + 2VV + 2WW + RCH = 0
                       COMPUTE W-REV-AR-INT  = (2CH + 2VV + 2WW)
      *                 DISPLAY "W-REV-INT : CAS1"
                    ELSE
                       COMPUTE W-REV-AR-INT  = 
                           (2CH + 2VV + 2WW)                    
                           - V-COEF-DECL * 4600 * ((2CH + 2VV + 2WW)
                           / (2CH + 2VV + 2WW + RCH))
      *                 DISPLAY "W-REV-INT : CAS2"                      
                    END-IF
                 ELSE
                    IF 2CH + 2VV + 2WW + RCH = 0
                       COMPUTE W-REV-AR-INT  =  
                                      (2CH + 2VV + 2WW)
                                      + RCH / NCH
      *                 DISPLAY "W-REV-INT : CAS3"
                    ELSE
                       COMPUTE W-REV-AR-INT  =  
                           (2CH + 2VV + 2WW)
                           - V-COEF-DECL * 4600 * ((2CH + 2VV + 2WW)   
                           / (2CH + 2VV + 2WW + RCH))
                           + (RCH             - V-COEF-DECL * 4600     
                           * RCH
                           / (2CH + 2VV + 2WW + RCH))
                           / NCH
      *                  DISPLAY "W-REV-INT : CAS4"
                    END-IF
                 END-IF.                          
      *           DISPLAY "W-REV-AR-INT-AVANT : " W-REV-AR-INT.
                 IF W-REV-AR-INT < 0 
                    MOVE 0 TO W-REV-AR-INT 
                 END-IF.
      *           DISPLAY "W-REV-AR-INT-APRES : " W-REV-AR-INT.    
                
                IF NTS <> 0 
                   COMPUTE V-RTS-NTS = RTS / NTS 
                END-IF.
      *          DISPLAY "V-RTS-NTS : " V-RTS-NTS.
                
                IF NTR <> 0 
                   COMPUTE V-RTR-NTR = RTR / NTR 
                END-IF.
      *          DISPLAY "V-RTR-NTR : " V-RTR-NTR.
                
                IF NGO <> 0 
                   COMPUTE V-RGO-NGO = RGO / NGO 
                END-IF.
      *          DISPLAY "V-RGO-NGO : " V-RGO-NGO.
                
                IF NVG <> 0 
                   COMPUTE V-RVG-NVG = RVG / NVG 
                END-IF.
      *          DISPLAY "V-RVG-NVG : " V-RVG-NVG.
                
                IF NUA <> 0 
                   COMPUTE V-RUA-NUA = RUA / NUA 
                END-IF.
      *          DISPLAY "V-RUA-NUA : " V-RUA-NUA.
                ...
                END-IF.
      *          DISPLAY "V-3UA-3VG-3VQ-RVG-NVG-RUA-NUA-3VR : " 
      *          V-3UA-3VG-3VQ-RVG-NVG-RUA-NUA-3VR.
                
                IF NBA <> 0 
                   COMPUTE V-RBA-NBA = RBA / NBA
                END-IF.
      *          DISPLAY "V-RBA-NBA : " V-RBA-NBA.
                
                IF TBA <> 0 
                   COMPUTE V-SBA-TBA = SBA / TBA
                END-IF.
      *          DISPLAY "V-SBA-TBA : " V-SBA-TBA.
                ...
                END-IF.
      *          DISPLAY "V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD : " 
      *          V-4BE-4BA-RBA-NBA-SBA-TBA-4BB-4BC-4BD.
                
               COMPUTE V-5OA-5OK-5OY-5OZ = 5OA + 5OK - 5OY - 5OZ.
               IF V-5OA-5OK-5OY-5OZ < 0 
                  MOVE 0 TO V-5OA-5OK-5OY-5OZ
               END-IF.
      *         DISPLAY "V-5OA-5OK-5OY-5OZ :" V-5OA-5OK-5OY-5OZ.

               COMPUTE V-5IR-5IS-5LY-5LV-5LW-5LD = 5IR - 5IS 
                                                 + 5LY + 5LV 
                                                 - 5LW - 5LD.
               IF V-5IR-5IS-5LY-5LV-5LW-5LD < 0 
                  MOVE 0 TO V-5IR-5IS-5LY-5LV-5LW-5LD
               END-IF.
      *         DISPLAY "V-5IR-5IS-5LY-5LV-5LW-5LD :" 
      *         V-5IR-5IS-5LY-5LV-5LW-5LD.
               
               COMPUTE V-5LQ-5LR-5OX-5OQ-5OR-5RZ = 5LQ - 5LR
                                + 5OX + 5OQ
                                - 5OR - 5RZ.
               IF V-5LQ-5LR-5OX-5OQ-5OR-5RZ < 0                         
                  MOVE 0 TO V-5LQ-5LR-5OX-5OQ-5OR-5RZ                   
               END-IF
      *         DISPLAY "V-5LQ-5LR-5OX-5OQ-5OR-5RZ :"                   
      *         V-5LQ-5LR-5OX-5OQ-5OR-5RZ
       .
      *****************************************************************        
      * Calcul des éléments composant la formule de calcul 
      ...
      *****************************************************************
       CALCUL-ELEMENTS-REV-SP.
          ...
          COMPUTE V-5KN-5KO-5KP-5KX-5KJ = 5KN + 5KO * (1 - 0.71)
                                          + 5KP * (1 - 0.5) 
                                          + 5KX - 5KJ.
          IF V-5KN-5KO-5KP-5KX-5KJ < 0                             
              MOVE 0 TO V-5KN-5KO-5KP-5KX-5KJ                       
          END-IF.
      *    DISPLAY "V-5KN-5KO-5KP-5KX-5KJ :" V-5KN-5KO-5KP-5KX-5KJ.     
            
          COMPUTE V-5HP-5HQ-5HV-5KZ = 5HP + 5HQ * (1 - 0.34)
                                       + 5HV - 5KZ.
          IF V-5HP-5HQ-5HV-5KZ < 0                                      
              MOVE 0 TO V-5HP-5HQ-5HV-5KZ                               
          END-IF.
      *    DISPLAY "V-5HP-5HQ-5HV-5KZ :" V-5HP-5HQ-5HV-5KZ.            

          IF NBJ <> 0 
             COMPUTE V-RBJ-NBJ = RBJ / NBJ 
          END-IF.

          COMPUTE V-5LN-5LO-5LP-5LX-5LJ = 5LN + 5LO * (1 - 0.71)
                                          + 5LP * (1 - 0.5)
                                          + 5LX - 5LJ.
          IF V-5LN-5LO-5LP-5LX-5LJ < 0                                  
              MOVE 0 TO V-5LN-5LO-5LP-5LX-5LJ                           
          END-IF.
      *    DISPLAY "V-5LN-5LO-5LP-5LX-5LJ :" V-5LN-5LO-5LP-5LX-5LJ .  
           
          COMPUTE V-5IP-5IQ-5IV-5LZ = 5IP + 5IQ * (1 - 0.34)
                                     + 5IV - 5LZ.
          IF V-5IP-5IQ-5IV-5LZ < 0                                      
              MOVE 0 TO V-5IP-5IQ-5IV-5LZ                               
          END-IF
      *    DISPLAY "V-5IP-5IQ-5IV-5LZ :" V-5IP-5IQ-5IV-5LZ            
       .
      * FGA - 10/2019 - PUMA - #409636 << 
      *****************************************************************
